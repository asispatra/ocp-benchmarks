...
#wget "https://raw.githubusercontent.com/asispatra/ocp-benchmarks/master/full/start_benchmark_and_collect_data.sh" -O start_benchmark_and_collect_data.sh
...
wget "https://raw.githubusercontent.com/asispatra/ocp-benchmarks/master/memory/getkmem_data.sh" -O getkmem_data.sh
